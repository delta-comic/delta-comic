...
vi.mock('../../../lib/driver/booter', () => ({ bootPlugin: mocks.bootPlugin }))
vi.mock('../../../lib/driver/builtIn', () => ({ isBuiltInPlugin: mocks.isBuiltInPlugin }))
vi.mock('../../../lib/driver/cleanup', () => ({ cleanupPlugin: mocks.cleanupPlugin }))
vi.mock('../../../lib/driver/extensions', () => ({
  runtimeExtensions: { loaders: { values: mocks.loaders } },
}))
vi.mock('../../../lib/driver/init/storage', () => ({ isTauriRuntime: () => false }))
