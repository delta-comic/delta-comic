...
vi.mock('../../../../../lib/driver/init/native', () => ({
  prepareDevScript: mocks.prepareDevScript,
  readLocalFile: mocks.readLocalFile,
}))
vi.mock('../../../../../lib/driver/init/storage', () => ({ isTauriRuntime: mocks.isTauriRuntime }))
vi.mock('../../../../../lib/i18n', () => ({ pluginMessageKey: (key: string) => key }))

import { _PluginInstallByFallbackUrl } from '../../../../../lib/features/core/installers/10_normalUrl'
import { _PluginInstallByLocal } from '../../../../../lib/features/core/installers/20_local'
import { _PluginInstallByDev } from '../../../../../lib/features/core/installers/30_dev'
