...
vi.mock('../../../../src/features/logs/loggerClient', () => ({
  loggerClient: { exportLogs: vi.fn(), listLogFiles: vi.fn(), readLogFile: vi.fn() },
}))

import type { LogReaderClient } from '../../../../src/features/logs/loggerClient'
import type { LogFileInfo } from '../../../../src/features/logs/model'
import { useLogReader } from '../../../../src/features/logs/useLogReader'
