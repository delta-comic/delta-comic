...
const componentSources = {
  ...import.meta.glob<string>('../../lib/**/*.vue', {
    eager: true,
    import: 'default',
    query: '?raw',
  }),
  ...import.meta.glob<string>('../../src/**/*.vue', {
    eager: true,
    import: 'default',
    query: '?raw',
  }),
}
const authoredComponentStyles = import.meta.glob<string>('../../lib/components/**/*.css', {
  eager: true,
  import: 'default',
  query: '?raw',
})
...
describe('UI component styling', () => {
  ...
  it('only keeps standalone CSS for the Markdown iframe theme', () => {
    expect(Object.keys(authoredComponentStyles).sort()).toEqual([
      '../../lib/components/DcMarkdown/dark.css',
      '../../lib/components/DcMarkdown/light.css',
    ])
  })
})