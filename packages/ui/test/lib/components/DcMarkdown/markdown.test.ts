...
import { createTemplate } from '../../../../lib/components/DcMarkdown/helper'
import DcMarkdown from '../../../../lib/components/DcMarkdown/index.vue'

const { isTauri, shellOpen } = vi.hoisted(() => ({ isTauri: vi.fn(), shellOpen: vi.fn() }))
vi.mock('@tauri-apps/api/core', () => ({ isTauri }))
vi.mock('@tauri-apps/plugin-shell', () => ({ open: shellOpen }))
vi.mock('../../../../lib/components/DcMarkdown/dark.css?inline', () => ({
  default: '/* dark-theme */',
}))
vi.mock('../../../../lib/components/DcMarkdown/light.css?inline', () => ({
  default: '/* light-theme */',
}))
